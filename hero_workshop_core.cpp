...
extern "C" {
void cxxbridge1$protobuf_entry_point(::rust::Vec<::std::uint8_t> *input, ::rust::Vec<::std::uint8_t> *return$) noexcept;
} // extern "C"

::rust::Vec<::std::uint8_t> protobuf_entry_point(::rust::Vec<::std::uint8_t> input) noexcept {
  ::rust::ManuallyDrop<::rust::Vec<::std::uint8_t>> input$(::std::move(input));
  ::rust::MaybeUninit<::rust::Vec<::std::uint8_t>> return$;
  cxxbridge1$protobuf_entry_point(&input$.value, &return$.value);
